package com.frostsowner.magic.weather.calendar;
...
public class CustomMonthView extends MonthView {
    ...
    public CustomMonthView(Context context) {
        ...
        mSolarTermTextPaint.setColor(0xff4ddd65);
        ...
        mCurrentDayPaint.setColor(0xffC14D4E);
        mCurrentDayPaint.setStrokeWidth(2f);
        ...
        linePaint.setColor(Color.parseColor("#F2F4F9"));
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected) {
        canvas.drawRect(x, y+mItemHeight-2, x + mItemWidth, y + mItemHeight, linePaint);
        int cx = x + mItemWidth / 2;
        int cy = y + mItemHeight / 2;
        ...
        if (calendar.isWeekend() && calendar.isCurrentMonth()){
            mCurMonthTextPaint.setColor(0xffC14D4E);
//            mCurMonthLunarTextPaint.setColor(0xffC14D4E);
...
//            mCurrentDayPaint.setColor(0xffC14D4E);
            ...
            mCurDayLunarTextPaint.setColor(0xff333333);
        ...
        if(calendar.getLunar().equals(calendar.getGregorianFestival()) || calendar.getLunar().equals(calendar.getTraditionFestival())){
            mCurMonthLunarTextPaint.setColor(0xffC14D4E);
        }else{
            mCurMonthLunarTextPaint.setColor(0xff333333);
        }

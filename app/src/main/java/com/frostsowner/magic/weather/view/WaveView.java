...
public class WaveView extends View {
    ...
    private int mBackgroudColor = DEFAULT_BACKGROUND_COLOR;
    ...
    public void setWaveColor(int backgroundColor,int behindWaveColor, int frontWaveColor) {
        ...
        if (mShowWave && mWaveShader != null) {
            ...
            switch (mShapeType) {
                ...
                case SQUARE:
                    ...
                    break;
                case CAPSULE:
                    canvas.drawRect(0,getWidth()/2f,getWidth(),getHeight()-getWidth()/2f,mViewPaint);
                    rectF.set(0,0,getWidth(),getWidth());
                    canvas.drawArc(rectF,180,180,true,mViewPaint);
                    rectF.set(0,getHeight()-getWidth()-1f,getWidth()-1f,getHeight());
                    canvas.drawArc(rectF,0,180,true,mViewPaint);
                    break;
            }
        } else {
